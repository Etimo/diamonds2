...
class WatchCompiler {
    ...
    run(configuration, configFilename, appName, onSuccess) {
        ...
        const origWatchStatusReporter = tsBin.createWatchStatusReporter(tsBin.sys);
        const host = tsBin.createWatchCompilerHost(configPath, {}, tsBin.sys, createProgram, this.createDiagnosticReporter(origDiagnosticReporter), this.createWatchStatusChanged(origWatchStatusReporter, onSuccess));
