...
const displayNestInformation = () => __awaiter(void 0, void 0, void 0, function* () {
    displayCliVersion();
    console.info(chalk_1.default.green('[Nest Platform Information]'));
    try {
...
const displayCliVersion = () => {
    console.info(chalk_1.default.green('[Nest CLI]'));
    console.info('Nest CLI Version :', chalk_1.default.blue(require('../package.json').version), '\n');
};
